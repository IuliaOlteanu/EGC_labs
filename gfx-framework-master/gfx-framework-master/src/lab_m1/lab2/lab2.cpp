...
void Lab2::Init()
{
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 1)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0, -1)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0, 0.5f)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(-1, 0, 1))
        };
...

    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 0, 0.5f))
        };
    ...
    // new tetrahedron
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.25f, 0, 0.5f)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0.25f, 0)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0, 0.25f)),


            VertexFormat(glm::vec3(0, 0, 2), glm::vec3(0.25f, 0, 0.5f)),
            VertexFormat(glm::vec3(0, 0, 2), glm::vec3(0, 0.25f, 0)),
            VertexFormat(glm::vec3(0, 0, 2), glm::vec3(0, 0, 0.25f)),


            VertexFormat(glm::vec3(2, 0, 0), glm::vec3(0.25f, 0, 0.5f)),
            VertexFormat(glm::vec3(2, 0, 0), glm::vec3(0, 0.25f, 0)),
            VertexFormat(glm::vec3(2, 0, 0), glm::vec3(0, 0, 0.25f)),


            VertexFormat(glm::vec3(0, 2, 0), glm::vec3(0.25f, 0, 0.5f)),
            VertexFormat(glm::vec3(0, 2, 0), glm::vec3(0, 0.25f, 0)),
            VertexFormat(glm::vec3(0, 2, 0), glm::vec3(0, 0, 0.25f)),

            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.75f, 0, 0.2f)),
            VertexFormat(glm::vec3(0, 0, 2), glm::vec3(0.75f, 0, 0.2f)),
            VertexFormat(glm::vec3(0, 2, 0), glm::vec3(0.75f, 0, 0.2f)),
        };
        ...
        CreateMesh("new_tetrahedron", vertices, indices);
    }
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-1, 1, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square

    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(2, -0.5f, 0), glm::vec3(0.25f));

    RenderMesh(meshes["new_tetrahedron"], shaders["VertexColor"], glm::vec3(2, 0.5f, 0), glm::vec3(0.25f));
